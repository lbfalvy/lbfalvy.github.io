...
`]}),`
`,t.exports.jsx(e.h3,{children:"Future"}),`
`,t.exports.jsx(e.p,{children:`I'd like to eventually fix the old prerenderer to generate all pages automatically,
that way they could all be indexed by search engines, and I could switch to
BrowserRouter and get rid of the nasty # in the URLs.`})]})}}export{g as default};
