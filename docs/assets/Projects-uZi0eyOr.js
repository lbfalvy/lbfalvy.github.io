import{R as e}from"./index-gZTrJf74.js";import{s as n,u as s,a as m}from"./useTags-KErV9qcS.js";import{c as o}from"./classList-dVscd13K.js";import{u}from"./useMetadata-hNLMbEyA.js";import{S as d}from"./SsrReady-O-a9cTrh.js";import"./ssrReady--xosRwNU.js";const b="_main_b0dtv_1",_={main:b};function f({name:a,url:l,children:r}){return e.createElement("a",{href:l,className:o(_.main,n.linkbox),target:"_blank"},e.createElement("article",null,e.createElement("h3",null,a),e.createElement("p",null,r)))}const p="_main_1qb79_1",g={main:p},y={name:"Orchid",url:"https://github.com/lbfalvy/orchid",tags:["rust","orchid","library","app"],description:`
	...
	`},I=Object.freeze(Object.defineProperty({__proto__:null,default:C},Symbol.toStringTag,{value:"Module"})),N={name:"Simple RTR",url:"https://github.com/lbfalvy/buffered-dispatch",tags:["library","ts","web"],description:`
		...
		define API calls.
	`},B=Object.freeze(Object.defineProperty({__proto__:null,default:N},Symbol.toStringTag,{value:"Module"})),D=Object.assign({"./Orchid.tsx":h,"./arnyekegyetem.tsx":w,"./buffered-dispatch.tsx":O,"./cv.tsx":T,"./f.engine.tsx":k,"./lbfalvy.github.io.tsx":R,"./mockable-timer.tsx":A,"./react-await.tsx":E,"./react-context-menu.tsx":I,"./simple-rtr.tsx":B}),q=Object.values(D).map(a=>a.default);function J(){const[a,l,r,i]=s(q,...m("filter"));return u("website","Projects","my humble portfolio",["portfolio"]),e.createElement("div",{className:o(g.main,n.sideBarContainer)},e.createElement(d,null),e.createElement("h2",null,"Projects"),e.createElement("header",{className:o(n.sideBar,n.filters)},l.map(t=>e.createElement("a",{key:t,href:"#",onClick:()=>i(t),className:o(r.includes(t)&&n.active,a.every(c=>!c.tags.includes(t))&&n.empty)},t))),e.createElement("main",null,a.map(t=>e.createElement(f,{name:t.name,url:t.url,key:t.name},t.description))))}export{J as default};
