import{j as e}from"./jsx-runtime.97000dc0.js";import{L as t}from"./LambdaHighlight.d66d3809.js";import"./index.cc569d2e.js";function h(s={}){const{wrapper:a}=s.components||{};return a?e.exports.jsx(a,Object.assign({},s,{children:e.exports.jsx(i,{})})):i();function i(){const n=Object.assign({h2:"h2",a:"a",i:"i",ul:"ul",li:"li",p:"p",h3:"h3",code:"code",em:"em"},s.components);return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsxs(n.h2,{id:"table-of-contents",children:[e.exports.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#table-of-contents",children:e.exports.jsx(n.i,{className:"linkbtn gg-link"})}),"Table of contents"]}),`
`,e.exports.jsxs(n.ul,{children:[`
`,e.exports.jsxs(n.li,{children:[e.exports.jsx(n.a,{href:"#rules",children:"Rules"}),`
`,e.exports.jsxs(n.ul,{children:[`
...
`,e.exports.jsx(n.li,{children:e.exports.jsx(n.a,{href:"#conclusion",children:"Conclusion"})}),`
`]}),`
`]}),`
`,e.exports.jsx(n.li,{children:e.exports.jsx(n.a,{href:"#future",children:"Future"})}),`
`]}),`
...
`,e.exports.jsx("a",{href:"https://www.lbfalvy.com/f.engine",children:"Lambda calculus executor"}),`
...
`,e.exports.jsxs(n.p,{children:[`If you aren't familiar with Lambda calculus, I suggest reading through the above tutorial
or the `,e.exports.jsx(n.a,{href:"https://en.wikipedida.org/wiki/Lambda_calculus",children:"Wikipedia page"}),"."]}),`
`,e.exports.jsxs(n.h2,{id:"rules",children:[e.exports.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#rules",children:e.exports.jsx(n.i,{className:"linkbtn gg-link"})}),"Rules"]}),`
...
to generics)`}),`
`]}),`
`,e.exports.jsx(n.p,{children:`Now, these are very different challenges and as far as I know no language apart from C
...
`,e.exports.jsx(n.p,{children:`The best thing about functional languages is the type system. Lambda calculus doesn't
...
`,e.exports.jsx(n.p,{children:`In many functional languages the type system is regarded as something isolated and untangible,
...
`,e.exports.jsx(n.p,{children:`As for syntax, I'm faced with an interesting challenge; choosing to ignore type inference
...
`,e.exports.jsx(t,{children:`func=\\arg:type. operation arg
func value:type
-- this is a comment`}),`
...
`,e.exports.jsx(t,{children:`$a + $b =5=> (add $a $b)
$a * $b =6=> (mult $a $b)
...
`,e.exports.jsx(n.p,{children:`This should be enough for most things we might want to do, but it's far too verbose for
...
`,e.exports.jsx(t,{children:"true := \\true.\\false.true"}),`
`,e.exports.jsxs(n.h3,{id:"conclusion",children:[e.exports.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#conclusion",children:e.exports.jsx(n.i,{className:"linkbtn gg-link"})}),"Conclusion"]}),`
`,e.exports.jsx(n.p,{children:`Given the above examples and fairly standard Lambda Calculus constants, the below example
is a reasonable guess at what the final code might look like:`}),`
`,e.exports.jsx(t,{children:`find := \\T. \\predicate:(\\item:T.Bool). \\list:Cons T. (
...
`}),`
`,e.exports.jsxs(n.p,{children:["Here ",e.exports.jsx(n.code,{children:"loop"})," is a more accessible keyword for the Y combinator and ",e.exports.jsx(n.code,{children:"T"}),` is a generic parameter.
...
`,e.exports.jsxs(n.h2,{id:"future",children:[e.exports.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#future",children:e.exports.jsx(n.i,{className:"linkbtn gg-link"})}),"Future"]}),`
`,e.exports.jsx(n.p,{children:`This is the first article in a series discussing aspects of programming language design.
...
it would be best to settle on most high level design decisions.`}),`
`,e.exports.jsx(n.p,{children:e.exports.jsx(n.em,{children:"ps: I updated the code samples in this article to keep the highlighting working. Changes:"})}),`
`,e.exports.jsxs(n.ul,{children:[`
`,e.exports.jsx(n.li,{children:e.exports.jsxs(n.em,{children:["replaced ",e.exports.jsx(n.code,{children:"="})," and ",e.exports.jsx(n.code,{children:"=="})," with ",e.exports.jsx(n.code,{children:":="})," in invariant rules"]})}),`
`]})]})}}export{h as default};
