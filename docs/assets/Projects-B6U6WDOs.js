import{R as e,S as s}from"./index-1MPAf_w-.js";import{s as n,u as m,a as u}from"./useTags-YnoLXoVj.js";import{c as o}from"./classList-dVscd13K.js";import{u as d}from"./useMetadata-zFtyyP6v.js";const b="_main_b0dtv_1",_={main:b};function f({name:a,url:l,children:r}){return e.createElement("a",{href:l,className:o(_.main,n.linkbox),target:"_blank"},e.createElement("article",null,e.createElement("h3",null,a),e.createElement("p",null,r)))}const p="_main_1qb79_1",g={main:p},y={name:"Orchid",url:"https://github.com/lbfalvy/orchid",tags:["rust","orchid","library","app"],description:`
	...
	`},k=Object.freeze(Object.defineProperty({__proto__:null,default:x},Symbol.toStringTag,{value:"Module"})),P={name:"This blog",url:"https://github.com/lbfalvy/lbfalvy.github.io",tags:["react","web","app","ts"],description:`
		This blog is written in React, and all content is managed through clever
		lazy-loading techniques. 
	`},R=Object.freeze(Object.defineProperty({__proto__:null,default:P},Symbol.toStringTag,{value:"Module"})),z={name:"Mockable Timer",url:"https://github.com/lbfalvy/mockable-timer",tags:["library","ts"],description:`
	...
	`},I=Object.freeze(Object.defineProperty({__proto__:null,default:C},Symbol.toStringTag,{value:"Module"})),N={name:"Simple RTR",url:"https://github.com/lbfalvy/buffered-dispatch",tags:["library","ts","web"],description:`
		...
		define API calls.
	`},B=Object.freeze(Object.defineProperty({__proto__:null,default:N},Symbol.toStringTag,{value:"Module"})),D=Object.assign({"./Orchid.tsx":h,"./arnyekegyetem.tsx":w,"./buffered-dispatch.tsx":O,"./cv.tsx":T,"./f.engine.tsx":k,"./lbfalvy.github.io.tsx":R,"./mockable-timer.tsx":A,"./react-await.tsx":E,"./react-context-menu.tsx":I,"./simple-rtr.tsx":B}),q=Object.values(D).map(a=>a.default);function V(){const[a,l,r,i]=m(q,...u("filter"));return d("website","Projects","my humble portfolio",["portfolio"]),e.createElement("div",{className:o(g.main,n.sideBarContainer)},e.createElement(s,null),e.createElement("h2",null,"Projects"),e.createElement("header",{className:o(n.sideBar,n.filters)},l.map(t=>e.createElement("a",{key:t,href:"#",onClick:()=>i(t),className:o(r.includes(t)&&n.active,a.every(c=>!c.tags.includes(t))&&n.empty)},t))),e.createElement("main",null,a.map(t=>e.createElement(f,{name:t.name,url:t.url,key:t.name},t.description))))}export{V as default};
