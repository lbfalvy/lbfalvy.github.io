import{R as e,c as l,s as n,u as s,a as u,b as m}from"./index-2a8bec30.js";const b="_main_b0dtv_1",d={main:b};function _({name:a,url:o,children:r}){return e.createElement("a",{href:o,className:l(d.main,n.linkbox),target:"_blank"},e.createElement("article",null,e.createElement("h3",null,a),e.createElement("p",null,r)))}const f="_main_1qb79_1",p={main:f},g={name:"Orchid",url:"https://github.com/lbfalvy/orchid",tags:["rust","orchid","library","app"],description:`
    ...
    `},C=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"})),I={name:"Simple RTR",url:"https://github.com/lbfalvy/buffered-dispatch",tags:["library","ts","web"],description:`
        ...
        define API calls.
    `},N=Object.freeze(Object.defineProperty({__proto__:null,default:I},Symbol.toStringTag,{value:"Module"})),B=Object.assign({"./Orchid.tsx":y,"./arnyekegyetem.tsx":v,"./buffered-dispatch.tsx":j,"./cv.tsx":S,"./f.engine.tsx":x,"./lbfalvy.github.io.tsx":k,"./mockable-timer.tsx":z,"./react-await.tsx":M,"./react-context-menu.tsx":C,"./simple-rtr.tsx":N}),D=Object.values(B).map(a=>a.default);function G(){const[a,o,r,i]=s(D,...u("filter"));return m("website","Projects","my humble portfolio",["portfolio"]),e.createElement("div",{className:l(p.main,n.sideBarContainer)},e.createElement("h2",null,"Projects"),e.createElement("header",{className:l(n.sideBar,n.filters)},o.map(t=>e.createElement("a",{href:"#",onClick:()=>i(t),className:l(r.includes(t)&&n.active,a.every(c=>!c.tags.includes(t))&&n.empty)},t))),e.createElement("main",null,a.map(t=>e.createElement(_,{name:t.name,url:t.url}," key=",t.name,t.description))))}export{G as default};
