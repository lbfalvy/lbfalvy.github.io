import{j as e}from"./jsx-runtime-82b96a72.js";import{L as r,H as a}from"./LambdaHighlight-2768f9a0.js";import"./index-b343c6e9.js";import"./classList-dea12197.js";function o(n){const t=Object.assign({h3:"h3",a:"a",i:"i",p:"p",em:"em"},n.components);return e.jsxs(e.Fragment,{children:[e.jsxs(t.h3,{id:"the-story-so-far",children:[e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#the-story-so-far",children:e.jsx(t.i,{className:"linkbtn gg-link"})}),"The story so far"]}),`
...
`,e.jsx(r,{children:`start_collection =9=> collection_carriage(())
...
`,e.jsx(r,{children:`a b start_collection c d add e add f g add add h end_collection i --r1
...
`,e.jsx(r,{children:`...$data:2 -- matches 1..n tokens
...
`,e.jsx(r,{children:`...$lhs:1 + ...$rhs =50=> add (...$lhs) (...$rhs)
...
`,e.jsx(r,{children:`-------- In std::macro_error --------
