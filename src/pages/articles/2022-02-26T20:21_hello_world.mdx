...
I'd like to figure out a Github workflow to do the deployments for me, currently the output
bundle shows up in my commit log which is far from ideal. I could also write a bash script
for this purpose, which has the advantage that it's platform independent, and I wouldn't
have to learn anything new probably. I'll be honest, I'm a bit tired of learning
right now.